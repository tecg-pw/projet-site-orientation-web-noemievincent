...
return [
    ...
    'single' => [
        ...
        'infos' => '<p>published on the <time datetime=":datetime">:date</time> by :author in <a href="#" class="underline underline-offset-2 decoration-1 decoration-solid hover:text-orange">:category</a></p>',
    ],
];
