...
return [
    ...
    'forum_tabs' => [
        'user' => [
            ...
            'replies' => 'Mes réponses',
        ],
        'guest' => [
            'questions' => '{male} Ses questions|{female} Ses questions',
            'replies' => '{male} Ses réponses|{female} Ses réponses',
        ],
    ],
    'edit' => [
        'head_title' => 'Modifier mes informations',
        'back_to_profile_link' => 'Retour au profil',
        'informations_form_title' => 'Modifier votre profil',
        'password_form_title' => 'Modifier votre mot de passe',
    ],
];
