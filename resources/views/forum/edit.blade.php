                    ...
                    <form action="/{{app()->getLocale()}}/forum/questions/{{$question->slug}}/edit" method="post"
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <textarea name="body" id="body" cols="30" rows="10"
                                      class="@error('body') error-outline @enderror pl-3 py-2 bg-orange-light/20 border border-orange-light rounded-lg focus:outline focus:outline-1 focus:outline-orange transition ease-in-out duration-200">{{old('body') ?? $question->body}}</textarea>
                        </div>
