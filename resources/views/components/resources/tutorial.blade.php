            ...
            <div class="flex justify-between mb-2">
                ...
                <a href="#" class="relative group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                         viewBox="0 0 24 24"
                         class="stroke-1  {{$is_favorite === true ? 'fill-orange stroke-orange' : 'fill-orange-light/0 stroke-orange-light'}} group-hover:fill-orange-light group-hover:stroke-orange-light transition-all ease-in-out duration-200">
