    ...
    <div class="flex flex-col gap-3">
        <div>
            <div class="flex justify-between mb-2">
                <h3 class="text-xl font-semibold underline underline-offset-2 decoration-2 decoration-solid hover:text-orange transition ease-in-out duration-200">
                    <a href="#">
                ...
                <a href="#" class="relative z-30 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                         viewBox="0 0 24 24"
                         class="fill-none group-hover:fill-orange/30">
                        <path stroke="#AB630D" stroke-linecap="round"
