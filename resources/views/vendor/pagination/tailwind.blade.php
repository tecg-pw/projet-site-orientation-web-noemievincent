    ...
    <nav aria-labelledby="pagination" aria-label="{{ __('Pagination Navigation') }}"
        ...
        <div class="flex justify-between flex-1 sm:hidden">
            <div class="flex gap-3">
                ...
                @else
                    <a href="{{ $paginator->url(1) }}" rel="prev" data-page="1"
                       class="skip-previous relative inline-flex items-center transition ease-in-out duration-150 group/skip-previous"
                ...
                @else
                    <a href="{{ $paginator->previousPageUrl() }}" rel="prev" data-page="-1"
                       class="previous relative inline-flex items-center px-2 py-2 rounded-l-md leading-5 active transition ease-in-out duration-150 group/previous"
            ...
            <div class="flex gap-3">
                ...
                @if ($paginator->hasMorePages())
                    <a href="{{ $paginator->nextPageUrl() }}" rel="next" data-page="1"
                       class="next relative inline-flex items-center px-2 py-2 rounded-l-md leading-5 active transition ease-in-out duration-150 group/next"
                ...
                {{-- Skip Next Page Link --}}
                @if ($paginator->hasMorePages())
                    <a href="{{ $paginator->url($paginator->lastPage()) }}" rel="next" data-page="{{ $paginator->url($paginator->lastPage()) }}"
                       class="skip-next relative inline-flex items-center transition ease-in-out duration-150 group/skip-next"
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center sm:gap-6">
            ...
            <div class="flex gap-3">
                ...
                {{-- Skip Next Page Link --}}
                @if ($paginator->hasMorePages())
                    <a href="{{ $paginator->url($paginator->lastPage()) }}" rel="next" data-page="{{ $paginator->lastPage() }}"
                       class="skip-next relative inline-flex items-center transition ease-in-out duration-150 group/skip-next"
                       aria-label="{{ __('pagination.skip-next') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="20" viewBox="0 0 17 20">
                            <g transform="translate(87 0)" class="fill-orange group-hover/skip-next:fill-orange-dark transition ease-in-out duration-150">
