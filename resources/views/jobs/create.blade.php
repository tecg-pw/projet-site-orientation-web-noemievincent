                        ...
                        <div class="flex flex-col gap-6">
                            <div class="flex flex-col gap-2">
                                <div class="radio-btn--parent flex gap-3 items-center">
                                    <input type="radio" id="email-reception" name="reception_mode" value="email" data-input_id="applications-email"
                                    ...
                                    <label for="email-reception"
                                        ...
                                        <span class="text-sm font-light">{{__('jobs.create.form.reception_mode.taglines.email')}}</span>
                                    </label>
                                </div>
                                <div class="ml-6">
                                    <label for="applications-email" class="@error('applications_email') not-sr-only @enderror sr-only">
                            ...
                            <div class="flex flex-col gap-2">
                                <div class="flex gap-3 items-center">
                                    <input type="radio" id="url-reception" name="reception_mode" value="url" data-input_id="applications-url"
                                ...
                                <div class="ml-6">
                                    <label for="applications-url" class="@error('applications_url') not-sr-only @enderror sr-only">
