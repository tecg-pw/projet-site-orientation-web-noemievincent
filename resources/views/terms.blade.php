        ...
        <div class="flex flex-col gap-12">
            <div class="flex flex-col gap-2">
                ...
                <p class="">{{__('L’adresse de notre site Web est : ')}}
                    <a href="https://webdesign.be"
                       class="underline decoration-solid decoration-1 underline-offset-2 hover:text-orange">https://webdesign.be</a>
                </p>
            </div>
            <div class="flex flex-col gap-2">
                <p class="text-xl font-semibold text-blue">{{__('Clause de confidentialité')}}</p>
            ...
            <div class="flex flex-col gap-2">
                <p class="text-xl font-semibold text-blue">{{__('Contenu embarqué depuis d’autres sites')}}</p>
